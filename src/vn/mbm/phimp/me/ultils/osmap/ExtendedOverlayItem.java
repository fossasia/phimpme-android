...
public class ExtendedOverlayItem extends OverlayItem {
	...
	private String mTitle, mDescription, mFilepath; // now, they are modifiable
	...
	public ExtendedOverlayItem(String aTitle, String aDescription, String filepath,
	...
	/*public Drawable getImage() {
		mImage = Drawable.createFromPath(mFilepath);		
		return mImage;
	}*/
