...
public class ImgurDBAdapter {
	private DatabaseHelperImgur DBHelper;
	...
	private static final String DATABASE_TABLE = "account_imgur";
	...
	public ImgurDBAdapter(Context ctx)
	{
		this.context = ctx;
		DBHelper = new DatabaseHelperImgur(context);
	}
	
	private static class DatabaseHelperImgur extends SQLiteOpenHelper
	{

		DatabaseHelperImgur(Context context) 
		{
	...
	public ImgurDBAdapter open() throws SQLException
	{
	...
	public boolean insert(String account_id, String token, String token_secret, String user_name) 
	{
	...
	public Cursor getItem(String id)
	{
		...
		return db.query(
				DATABASE_TABLE, 
				new String[] { ACCOUNT_ID, TOKEN, TOKEN_SECRET, USER_NAME}, 
				selection, 
				agruments, 
				null, 
				null, 
