...
public class SohuDBAdapter {
	private DatabaseHelperSohu DBHelper;
	...
	private static final String DATABASE_TABLE = "account_sohu";
	...
	public SohuDBAdapter(Context ctx)
	{
		this.context = ctx;
		DBHelper = new DatabaseHelperSohu(context);
	}
	
	private static class DatabaseHelperSohu extends SQLiteOpenHelper
	{

		DatabaseHelperSohu(Context context) 
		{
	...
	public SohuDBAdapter open() throws SQLException
	{
	...
	public boolean insert(String account_id,String user_id, String token, String token_secret, String user_name) 
	{
	...
	public Cursor getItem(String id)
	{
		...
		return db.query(
				DATABASE_TABLE, 
				new String[] { ACCOUNT_ID,USER_ID, TOKEN, TOKEN_SECRET, USER_NAME}, 
				selection, 
				agruments, 
				null, 
				null, 
