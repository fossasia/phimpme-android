...
public class DownloadedPersonalPhotoDBItem {
	public String id;
	...
	public synchronized static boolean insert(Context ctx, String id, String filepath, String thumbpath, String title, String latitude, String longitude, String link, String service, String description)
	{
		...
		DownloadedPersonalPhotoDBAdapter db = new DownloadedPersonalPhotoDBAdapter(ctx);
		db.open();
	...
	public static ArrayList<DownloadedPersonalPhotoDBItem> getAll(Context ctx)
	{
		ArrayList<DownloadedPersonalPhotoDBItem> items = new ArrayList<DownloadedPersonalPhotoDBItem>();
		...
		if (c.moveToFirst())
		{
			do
			{
				DownloadedPersonalPhotoDBItem item = new DownloadedPersonalPhotoDBItem();
