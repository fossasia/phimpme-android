...
public class S500pxDBAdapter {
	private DatabaseHelper500px DBHelper;
	...
	private static final String DATABASE_TABLE = "account_500px";
	...
	public S500pxDBAdapter(Context ctx)
	{
		this.context = ctx;
		DBHelper = new DatabaseHelper500px(context);
	}
	
	private static class DatabaseHelper500px extends SQLiteOpenHelper
	{

		DatabaseHelper500px(Context context) 
		{
	...
	public S500pxDBAdapter open() throws SQLException
	{
