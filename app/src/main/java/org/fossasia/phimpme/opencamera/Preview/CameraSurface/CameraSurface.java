...
/**
 * Provides support for the surface used for the preview - this can either be a SurfaceView or a
 * TextureView.
 */
public interface CameraSurface {
  ...
  void setPreviewDisplay(
      CameraController
          camera_controller); // n.b., uses double-dispatch similar to Visitor pattern - behaviour
  // depends on type of CameraSurface and CameraController
