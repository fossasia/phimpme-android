...
public class UploadHisDiffCallback extends DiffUtil.Callback {
    ...
    public UploadHisDiffCallback(List<UploadHistoryRealmModel> oldUploadHisList,
    ...
    @Override public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
        return oldUploadHisList.get(oldItemPosition).getPathname() == newUploadHisList.get(newItemPosition)
                .getPathname();
    }
