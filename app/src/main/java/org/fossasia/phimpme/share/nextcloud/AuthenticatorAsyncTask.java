 ...
 *
 * @author masensio on 09/02/2015. Copyright (C) 2015 ownCloud Inc.
...
public class AuthenticatorAsyncTask extends AsyncTask<Object, Void, RemoteOperationResult> {
  ...
  protected RemoteOperationResult doInBackground(Object... params) {
    ...
    if (params != null && params.length == 2) {
      ...
      ExistenceCheckRemoteOperation operation =
          new ExistenceCheckRemoteOperation(REMOTE_PATH, mContext, SUCCESS_IF_ABSENT);
