...
import org.fossasia.phimpme.gallery.SecretConstants;
...
public enum StaticMapProvider {
  ...
  // String.format is locale dependent, we need to force a locale with point instead of comma in
  // decimals,
  ...
  private String getUrl(int value) {
    switch (value) {
      ...
      case 1:
        return "https://api.mapbox.com/v4/mapbox.streets/%f,%f,15/500x300.jpg?access_token="
            + SecretConstants.MAP_BOX_TOKEN;
      case 2:
        return "https://api.mapbox.com/v4/mapbox.dark/%f,%f,15/500x300.jpg?access_token="
            + SecretConstants.MAP_BOX_TOKEN;
      case 3:
        return "https://api.mapbox.com/v4/mapbox.light/%f,%f,15/500x300.jpg?access_token="
            + SecretConstants.MAP_BOX_TOKEN;
      case 4:
