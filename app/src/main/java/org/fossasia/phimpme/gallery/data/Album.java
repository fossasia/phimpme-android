...
public class Album implements Serializable {
    ...
    private void setPreviewPath(String previewPath) {
    ...
    private void setPreviewSelected(boolean previewSelected) {
     ...
     *
     * @param targetIndex Index of the last photo in the new selected list
     * @param adapter     Current MediaAdapter object
     */
