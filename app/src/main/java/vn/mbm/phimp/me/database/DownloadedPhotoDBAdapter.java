...
public class DownloadedPhotoDBAdapter 
{
	...
	private static final String DATABASE_TABLE = "rssphotoitem";
	...
	public DownloadedPhotoDBAdapter(Context ctx)
	{
		this.context = ctx;
	...
	private static class DatabaseHelper extends SQLiteOpenHelper
	{
		...
		public void onCreate(SQLiteDatabase db) 
		{
			try
			{
				...
				Log.i("Download Photo", "Run SQL: " + DATABASE_CREATE);
			}
	...
	public synchronized DownloadedPhotoDBAdapter open() throws RuntimeException,SQLException
	{
