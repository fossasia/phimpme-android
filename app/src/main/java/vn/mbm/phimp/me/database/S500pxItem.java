...
public class S500pxItem {
	...
	public static boolean insert500pxAccount(Context ctx, String account_id, String token, String token_secret, String user_id, String user_name, String profile_url)
	{
		boolean result;
		
		S500pxDBAdapter db = new S500pxDBAdapter (ctx);
		db.open();
	...
	public static S500pxItem getItem(Context ctx, String id)
	{
		S500pxItem item = new S500pxItem();
