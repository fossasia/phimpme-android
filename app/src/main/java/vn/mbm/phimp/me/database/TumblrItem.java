...
public class TumblrItem 
{
	...
	public static boolean insertTumblrAccount(Context ctx, String account_id, String token, String token_secret, String user_id, String user_name, String profile_url)
	{
		boolean result;
		
		TumblrDBAdapter db = new TumblrDBAdapter(ctx);
		db.open();
	...
	public static TumblrItem getItem(Context ctx, String id)
	{
