...
public class FlickrDBAdapter 
{
	private DatabaseHelperFlickr DBHelper;
	...
	private static final String DATABASE_TABLE = "account_flickr";
	...
	public FlickrDBAdapter(Context ctx)
	{
		this.context = ctx;
		DBHelper = new DatabaseHelperFlickr(context);
	}
	
	private static class DatabaseHelperFlickr extends SQLiteOpenHelper
	{

		DatabaseHelperFlickr(Context context) 
		{
	...
	public FlickrDBAdapter open() throws SQLException
	{
