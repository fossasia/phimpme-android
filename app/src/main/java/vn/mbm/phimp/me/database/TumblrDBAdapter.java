...
public class TumblrDBAdapter 
{
	private DatabaseHelperTumblr DBHelper;
	...
	private static final String DATABASE_TABLE = "account_tumblr";
	...
	public TumblrDBAdapter(Context ctx)
	{
		this.context = ctx;
		DBHelper = new DatabaseHelperTumblr(context);
	}
	
	private static class DatabaseHelperTumblr extends SQLiteOpenHelper
	{

		DatabaseHelperTumblr(Context context) 
		{
	...
	public TumblrDBAdapter open() throws SQLException
	{
