...
public class FlickrItem 
{
	...
	public static boolean insertFlickrAccount(Context ctx, String account_id, String token, String token_secret, String user_id, String user_name, String profile_url)
	{
		boolean result;
		
		FlickrDBAdapter db = new FlickrDBAdapter(ctx);
		db.open();
	...
	public static FlickrItem getItem(Context ctx, String id)
	{
