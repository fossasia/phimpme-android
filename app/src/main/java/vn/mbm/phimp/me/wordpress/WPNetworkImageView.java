...
public class WPNetworkImageView extends AppCompatImageView {
    ...
    private void loadImageIfNecessary(final boolean isInLayoutPass,
        ...
        // from the network.
        ImageLoader.ImageContainer newContainer = MyApplication.sImageLoader.get(mUrl,
    ...
    private void handleResponse(ImageLoader.ImageContainer response, boolean isCached, ImageLoadListener
        ...
        if (response.getBitmap() != null) {
            ...
            if (mImageType == ImageType.PHOTO_ROUNDED) {
    ...
    public void showDefaultImage() {
        ...
        switch (mImageType) {
            ...
            default :
                ...
                setImageDrawable(new ColorDrawable(getColorRes(R.color.grey_lighten_20)));
                break;
        }
    }
    ...
    private void showErrorImage() {
        ...
        switch (mImageType) {
            ...
            default :
                ...
                setImageDrawable(new ColorDrawable(getColorRes(R.color.grey_lighten_10)));
                break;
        }
    }
