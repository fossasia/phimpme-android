...
public final class ReleaseNetworkModule_ProvideRequestQueueFactory implements Factory<RequestQueue> {
  ...
  public ReleaseNetworkModule_ProvideRequestQueueFactory(ReleaseNetworkModule module, Provider<Builder> okHttpClientBuilderProvider, Provider<Context> appContextProvider) {  
    assert module != null;
    this.module = module;
  ...
  public RequestQueue get() {  
    RequestQueue provided = module.provideRequestQueue(okHttpClientBuilderProvider.get(), appContextProvider.get());
    if (provided == null) {
  ...
  public static Factory<RequestQueue> create(ReleaseNetworkModule module, Provider<Builder> okHttpClientBuilderProvider, Provider<Context> appContextProvider) {  
    return new ReleaseNetworkModule_ProvideRequestQueueFactory(module, okHttpClientBuilderProvider, appContextProvider);
  }
}
